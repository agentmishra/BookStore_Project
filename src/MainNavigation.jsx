...
import AddBook from './Pages/EditBook';
...
export const MainNavigation = () => {
  ...
  const Redirect=<Navigate to='/login'/>
    ...
    return <Routes>
        ...
        <Route exact path='/add-book' element={user.id ? <EditBook /> : Redirect}></Route>
        <Route exact path='/edit-book/:id' element={user.id ? <EditBook /> : Redirect}></Route>
